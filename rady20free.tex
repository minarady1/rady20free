...
\newcommand{\orcidauthorMR}{0000-0003-2529-8272} % Add \orcidA{} behind the author's name


% Authors, for the paper (add full first names)
\Author{Mina~Rady $^{1,2}$\orcidMR{}, Quentin~Lampin $^{1}$,  Dominique~Barthel $^{1}$* and  Thomas~Watteyne  $^{2}$}

% Authors, for metadata in PDF
\AuthorNames{Mina~Rady,  Quentin~Lampin, Dominique~Barthel, and Thomas~Watteyne }

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Orange Labs, 38240 Meylan, France; mina1.rady@orange.com, quentin.lampin@orange.com, dominique.barthel@organge.com. 
$^{2}$ \quad Inria, EVA Team, 75012 Paris, France 3; Thomas.Watteyne@e-mail.com}
...
\begin{figure*}
	...
	\begin{subfigure}{0.6\columnwidth}
	\centering
	\includegraphics[width=1\columnwidth]{dagrank_time}
    \subcaption{Mean and inter-quartile range of measurements in the time domain }
    \label{fig:dagrank_time}
	\end{subfigure}
	\begin{subfigure}{0.6\columnwidth}
		\centering
    	\includegraphics[width=01\columnwidth]{dagrank_cdf}
    	\subcaption{CDF of  the measurements for the network at steady state }
	...
	\begin{subfigure}{0.6\columnwidth}
		\centering
	\includegraphics[width=1\columnwidth]{dagrank_pdf}
	\subcaption{PDF of  the measurements for the network at steady state }
...
\begin{figure*}
	...
	\begin{subfigure}{0.6\columnwidth}
	\centering
	\includegraphics[width=1\columnwidth]{dutyCycle_time}
    \subcaption{Mean and inter-quartile range of measurements in the time domain }
    \label{fig:dutyCycle_time}
	\end{subfigure}
	\begin{subfigure}{0.6\columnwidth}
		\centering
    	\includegraphics[width=01\columnwidth]{dutyCycle_cdf}
    	\subcaption{CDF of  the measurements for the network at steady state }
	...
	\begin{subfigure}{0.6\columnwidth}
		\centering
	\includegraphics[width=1\columnwidth]{dutyCycle_pdf}
	\subcaption{PDF of  the measurements for the network at steady state  }
