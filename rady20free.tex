...
Therefore, it is essentially non-deterministic and the network performance depends heavily on the level of contention in the medium~\cite{adelantado17understandinga}.

% popular PHY layers

Another major player in the IIoT communications market is the set of technologies under the IEEE802.15.4 family of standards which were conceived in 2003 yet extended in several amendments since then.~\cite{11ieee}
...
\begin{figure*}
	...
	\centering
	\includegraphics[width=1\columnwidth]{numNeighbors_plot_mean}
...
\begin{figure*}
	...
	\begin{subfigure}{0.6\columnwidth}
	\centering
	\includegraphics[width=1\columnwidth]{latency_plot_mean}
    \subcaption{Mean and inter-quartile range of measurements in the time domain }
    \label{fig:latency_time}
	\end{subfigure}
	\begin{subfigure}{0.6\columnwidth}
		\centering
    	\includegraphics[width=01\columnwidth]{latency_cdf_plot_full_steady}
    	\subcaption{CDF of  the measurements for the network at steady state }
	...
	\begin{subfigure}{0.6\columnwidth}
		\centering
	\includegraphics[width=1\columnwidth]{latency_pdf_plot_full_steady_normalized}
	\subcaption{PDF of  the measurements for the network at steady state}
...
\begin{figure*}
	...
	\begin{subfigure}{0.6\columnwidth}
	\centering
	\includegraphics[width=1\columnwidth]{dutyCycle_plot_mean}
    \subcaption{Mean and inter-quartile range of measurements in the time domain }
    \label{fig:dutyCycle_time}
	\end{subfigure}
	\begin{subfigure}{0.6\columnwidth}
		\centering
    	\includegraphics[width=01\columnwidth]{dutyCycle_cdf_plot_full_steady}
    	\subcaption{CDF of  the measurements for the network at steady state }
	...
	\begin{subfigure}{0.6\columnwidth}
		\centering
	\includegraphics[width=1\columnwidth]{dutyCycle_pdf_plot_full_steady_normalized}
	\subcaption{PDF of  the measurements for the network at steady state  }
