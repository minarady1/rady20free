...
\newcommand{\orcidauthorA}{0000-0003-2529-8272} % Add \orcidA{} behind the author's name


% Authors, for the paper (add full first names)
\Author{Mina~Rady $^{1,2}$\orcidA{}, Quentin~Lampin $^{1}$,  Dominique~Barthel $^{1}$ and  Thomas~Watteyne  $^{2}$}
